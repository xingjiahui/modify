 ...
 * Last Update: 2020/6/25 下午22:00:18
 * Modify by XJHui @https://xingjiahui.top
 */
!function (e, t) {
    ...
    return function (e) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            }, i = n(38), a = r(i), s = n(28), l = r(s), c = n(27), u = r(c), d = n(42), p = r(d), f = document,
        ...
        var i, a, s = function () {
            ...
            }, g = n(4), m = g.call(Function.call, String.prototype.replace),
            y = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
            b = /\\(\\)?/g, w = function (e) {
                var t = [];
        ...
        var r = n(2), o = {
            cdn: r.DEFAULT_EMOJI_CDN, maps: n(53), parse: function (e) {
                ...
                var t = /^(https?:)?\/\//i, n = o.maps[e], r = t.test(n) ? n : o.cdn + n;
        ...
        "use strict";
        var r = n(40), o = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"),
        ...
        "use strict";
        var r = n(45), o = n(44), i = n(46), a = i("String.prototype.replace"),
        ...
        "use strict";
        var r = n(4), o = n(1), i = o("%Function%"), a = i.apply, s = i.call;
        e.exports = function () {
        ...
        var x = n(3).FilterCSS, k = n(3).getDefaultWhiteList, _ = n(5), A = new x, S = /</g, O = />/g, $ = /"/g,
            E = /&quot;/g, j = /&#([a-zA-Z0-9]*);?/gim, T = /&colon;?/gim, C = /&newline;?/gim,
            I = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            P = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, M = /u\s*r\s*l\s*\(.*/gi, R = /<!--[\s\S]*?-->/g;
...
*/
        ...
        var a = n(26), s = r(a), l = n(17), c = r(l), u = n(20), d = r(u), p = n(6), f = r(p), h = n(2), v = n(24),
            g = r(v), m = n(0), y = r(m), b = n(22), w = r(b), x = n(19), k = r(x), _ = n(23), A = n(25), S = r(A),
            O = n(21), $ = r(O),
            E = {comment: "", nick: "", mail: "", link: "", ua: y.default.ua, url: "", QQAvatar: ""}, j = "", T = {
        ...
        o.prototype.init = function (e) {
            ...
            try {
                ...
                var p = e.config.el || null, f = (0, y.default)(p);
                if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
                    ...
                    var b = e.$el.find(".vload-bottom"), w = e.$el.find(".vload-top");
                    e.$loading = {
                        show: function (t) {
                ...
                (0, k.default)(e.config, function (t) {
                    var n = (0, y.default)(".valine-comment-count"), r = 0;
                    !function t(n) {
                        var o = n[r++];
                        if (o) {
        ...
        var C = function (e, t) {
            ...
            add: function (e, t) {
                var n = this, r = (0, y.default)(".leancloud_visitors,.leancloud-visitors");
                if (1 === r.length) {
                    var o = r[0], i = decodeURI((0, y.default)(o).attr("id")),
                        a = (0, y.default)(o).attr("data-flag-title"), s = encodeURI(i),
                    ...
                    r.containedIn("url", n), r.find().then(function (e) {
                        e.length > 0 && t.forEach(function (t) {
                            e.forEach(function (e) {
                                var n = e.get("xid") || encodeURI(e.get("url")), r = e.get("time"),
                                    o = (0, y.default)(t), i = o.attr("id");
        ...
        o.prototype.Q = function (e) {
            ...
            var p = e.config.meta, v = {}, m = {veditor: "comment"};
            p.forEach(function (e) {
                m["v" + e] = e
            });
            for (var b in m) m.hasOwnProperty(b) && function () {
                var t = m[b], n = e.$el.find("." + b);
            ...
            }, k = {no: 1, size: e.config.pageSize, skip: e.config.pageSize}, A = e.$el.find(".vpage");
            ...
            var C = function (t, n, r) {
                var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'), i = t.get("ua"), a = "";
                ...
                var ism = e.config.master.includes(t.get("link")) && t.get("link") != '',
                    isf = e.config.friends.includes(t.get("link")) || e.config.friends.includes('http://'+t.get("link")) || e.config.friends.includes('https://'+t.get("link")),
            ...
            var z = e.$el.find(".vsubmit"), L = function (t) {
        ...
        t.__esModule = !0;
        var o = n(37), i = r(o), a = n(56), s = r(a), l = n(57), c = r(l), u = n(54), d = r(u), p = n(55), f = r(p),
            h = {
                zh: s.default,
                "zh-cn": s.default,
                "zh-CN": s.default,
        ...
        t.__esModule = !0;
        var o = n(36), i = r(o), a = n(0), s = r(a), l = n(6), c = r(l), u = n(33), d = new o.Renderer;
        d.code = function (e, t) {
        ...
        "use strict";
        var r = n(35), o = Object.prototype.toString, i = Object.prototype.hasOwnProperty, a = function (e, t, n) {
        ...
        var u = n(31), d = n(50), p = n(34), f = n(43), h = function (e) {
            d(!1, e)
...
*/
        ...
        var r;
        if (!Object.keys) {
            var o = Object.prototype.hasOwnProperty, i = Object.prototype.toString, a = n(10),
        ...
        "use strict";
        var r = Array.prototype.slice, o = n(10), i = Object.keys, a = i ? function (e) {
            return i(e)
        } : n(39), s = Object.keys;
        a.shim = function () {
            if (Object.keys) {
 ...
 */
        ...
        "use strict";
        var r = n(12), o = n(9), i = n(11), a = n(13), s = n(49), l = r(a());
        ...
        "use strict";
        var r = n(1), o = n(12), i = o(r("String.prototype.indexOf"));
        e.exports = function (e, t) {
            var n = r(e, !!t);
        ...
        var s = n(3).FilterCSS, l = n(15), c = n(16), u = c.parseTag, d = c.parseAttr, p = n(5);
